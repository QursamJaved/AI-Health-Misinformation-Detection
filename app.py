...
text = st.text_area("Health Claim:", height=150,
    placeholder="e.g. Drinking hot water kills COVID-19...")

if st.button("🔍 Check Now"):
    if text.strip():
        fake_words = ["cure", "miracle", "secret", 
                     "100%", "instant", "banned", "kills virus"]
...
st.markdown("---")
st.caption("Built with Python & Streamlit — SoftaVerse Tech House")
